...
class ProductVariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_variant" do
    assert_difference('ProductVariant.count') do
      post product_variants_url, params: { product_variant: { color: @product_variant.color, length: @product_variant.length, product_id: @product_variant.product_id, weight: @product_variant.weight } }
    end
  ...
  test "should update product_variant" do
    patch product_variant_url(@product_variant), params: { product_variant: { color: @product_variant.color, length: @product_variant.length, product_id: @product_variant.product_id, weight: @product_variant.weight } }
